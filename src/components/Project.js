    ...
    <div className="project-container">
      ...
      <Card className="card-container">
        <Card.Body className="card-body">
          <Card.Img src="./images/Filmster.png" className="proj-img"/>
          <Card.Title className="proj-title">Filmster</Card.Title>
      ...
      <Card className="card-container">
        <Card.Body>
          <Card.Img src="./images/Badjjr.png" className="proj-img"/>
          <Card.Title className="proj-title">BadJJR (Group Project)</Card.Title>
          <Card.Text className="proj-text">
          ...
          <Button className="proj-link-btn">
      ...
      <Card className="card-container">
        <Card.Body>
          <Card.Img src="./images/Valodex.png" className="proj-img"/>
          <Card.Title className="proj-title">Valodex</Card.Title>
          <Card.Text className="proj-text">
